...
| Docker | One supported root Compose file, entry-service/container-port detection, private site-port mapping, post-deploy port verification, Docker/Compose/daemon/configuration checks, host-safety validation, service status/logs, and lifecycle actions. |
